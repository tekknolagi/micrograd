...
double Neuron_0x7f7409f20460(Vector<double, 2> input) {
...
double Neuron_0x7f7409f209d0(Vector<double, 2> input) {
  Vector<double, 2> weights = {-0.26830328150124894, 0.1715747078045431};
  double result = weights.dot(input).sum() + 0;
  result = std::max(result, double{0});
  return result;
}
double Neuron_0x7f7409f20b50(Vector<double, 2> input) {
  Vector<double, 2> weights = {-0.6686254326224383, 0.6487474938152629};
  double result = weights.dot(input).sum() + 0;
  result = std::max(result, double{0});
  return result;
}
double Neuron_0x7f7409f20cd0(Vector<double, 2> input) {
  Vector<double, 2> weights = {-0.23259038277158273, 0.5792256498313748};
  double result = weights.dot(input).sum() + 0;
  result = std::max(result, double{0});
  return result;
}
double Neuron_0x7f7409f20e50(Vector<double, 2> input) {
  Vector<double, 2> weights = {0.8434530197925192, -0.3847332240409951};
  double result = weights.dot(input).sum() + 0;
  result = std::max(result, double{0});
  return result;
}
double Neuron_0x7f7409f20fd0(Vector<double, 2> input) {
  Vector<double, 2> weights = {0.9844941451716409, -0.5901079958448365};
  double result = weights.dot(input).sum() + 0;
  result = std::max(result, double{0});
  return result;
}
double Neuron_0x7f7409f21150(Vector<double, 2> input) {
  Vector<double, 2> weights = {0.31255526637777775, 0.8246106857787521};
  double result = weights.dot(input).sum() + 0;
  result = std::max(result, double{0});
  return result;
}
double Neuron_0x7f7409f212d0(Vector<double, 2> input) {
  Vector<double, 2> weights = {-0.7814232047574572, 0.6408752595662697};
  double result = weights.dot(input).sum() + 0;
  result = std::max(result, double{0});
  return result;
}
double Neuron_0x7f7409f21450(Vector<double, 2> input) {
  Vector<double, 2> weights = {-0.20252189189007108, -0.8693137391598071};
  double result = weights.dot(input).sum() + 0;
  result = std::max(result, double{0});
  return result;
}
double Neuron_0x7f7409f215d0(Vector<double, 2> input) {
  Vector<double, 2> weights = {0.39841666323128555, -0.3037961142013801};
  double result = weights.dot(input).sum() + 0;
  result = std::max(result, double{0});
  return result;
}
double Neuron_0x7f7409f21750(Vector<double, 2> input) {
  Vector<double, 2> weights = {-0.19282493884310759, 0.6032250931493106};
  double result = weights.dot(input).sum() + 0;
  result = std::max(result, double{0});
  return result;
}
double Neuron_0x7f7409f218d0(Vector<double, 2> input) {
  Vector<double, 2> weights = {0.6001302646227185, 0.32749776568749045};
  double result = weights.dot(input).sum() + 0;
  result = std::max(result, double{0});
  return result;
}
double Neuron_0x7f7409f21a50(Vector<double, 2> input) {
  Vector<double, 2> weights = {0.6650130652363544, 0.1889136153241595};
  double result = weights.dot(input).sum() + 0;
  result = std::max(result, double{0});
  return result;
}
double Neuron_0x7f7409f21bd0(Vector<double, 2> input) {
  Vector<double, 2> weights = {-0.07813264062433589, 0.9151267732861252};
  double result = weights.dot(input).sum() + 0;
  result = std::max(result, double{0});
  return result;
}
double Neuron_0x7f7409f21d50(Vector<double, 2> input) {
  Vector<double, 2> weights = {0.5914405264235476, -0.3725442040076463};
  double result = weights.dot(input).sum() + 0;
  result = std::max(result, double{0});
  return result;
}
double Neuron_0x7f7409f21ed0(Vector<double, 2> input) {
  Vector<double, 2> weights = {0.3810827422406471, 0.8301999957053683};
  double result = weights.dot(input).sum() + 0;
  result = std::max(result, double{0});
  return result;
}
Vector<double, 16> Layer_0x7f741798ff70(Vector<double, 2> input) {
  Vector<double, 16> result;
  result.at(0) = Neuron_0x7f7409f20460(input);
  result.at(1) = Neuron_0x7f7409f209d0(input);
  result.at(2) = Neuron_0x7f7409f20b50(input);
  result.at(3) = Neuron_0x7f7409f20cd0(input);
  result.at(4) = Neuron_0x7f7409f20e50(input);
  result.at(5) = Neuron_0x7f7409f20fd0(input);
  result.at(6) = Neuron_0x7f7409f21150(input);
  result.at(7) = Neuron_0x7f7409f212d0(input);
  result.at(8) = Neuron_0x7f7409f21450(input);
  result.at(9) = Neuron_0x7f7409f215d0(input);
  result.at(10) = Neuron_0x7f7409f21750(input);
  result.at(11) = Neuron_0x7f7409f218d0(input);
  result.at(12) = Neuron_0x7f7409f21a50(input);
  result.at(13) = Neuron_0x7f7409f21bd0(input);
  result.at(14) = Neuron_0x7f7409f21d50(input);
  result.at(15) = Neuron_0x7f7409f21ed0(input);
  return result;
}
double Neuron_0x7f7409f22080(Vector<double, 16> input) {
...
double Neuron_0x7f7409f22770(Vector<double, 16> input) {
  Vector<double, 16> weights = {
...
double Neuron_0x7f7409f22e30(Vector<double, 16> input) {
  Vector<double, 16> weights = {
...
double Neuron_0x7f7409f234f0(Vector<double, 16> input) {
  Vector<double, 16> weights = {
...
double Neuron_0x7f7409f23bb0(Vector<double, 16> input) {
  Vector<double, 16> weights = {
...
double Neuron_0x7f7409f442b0(Vector<double, 16> input) {
  Vector<double, 16> weights = {
...
double Neuron_0x7f7409f44970(Vector<double, 16> input) {
  Vector<double, 16> weights = {
...
double Neuron_0x7f7409f45030(Vector<double, 16> input) {
  Vector<double, 16> weights = {
...
double Neuron_0x7f7409f456f0(Vector<double, 16> input) {
  Vector<double, 16> weights = {
...
double Neuron_0x7f7409f45db0(Vector<double, 16> input) {
  Vector<double, 16> weights = {
...
double Neuron_0x7f7409f46470(Vector<double, 16> input) {
  Vector<double, 16> weights = {
...
double Neuron_0x7f7409f46b30(Vector<double, 16> input) {
  Vector<double, 16> weights = {
...
double Neuron_0x7f7409f471f0(Vector<double, 16> input) {
  Vector<double, 16> weights = {
...
double Neuron_0x7f7409f478b0(Vector<double, 16> input) {
  Vector<double, 16> weights = {
...
double Neuron_0x7f7409f47f70(Vector<double, 16> input) {
  Vector<double, 16> weights = {
...
double Neuron_0x7f7409f60670(Vector<double, 16> input) {
  Vector<double, 16> weights = {
...
Vector<double, 16> Layer_0x7f741798d8d0(Vector<double, 16> input) {
  Vector<double, 16> result;
  result.at(0) = Neuron_0x7f7409f22080(input);
  result.at(1) = Neuron_0x7f7409f22770(input);
  result.at(2) = Neuron_0x7f7409f22e30(input);
  result.at(3) = Neuron_0x7f7409f234f0(input);
  result.at(4) = Neuron_0x7f7409f23bb0(input);
  result.at(5) = Neuron_0x7f7409f442b0(input);
  result.at(6) = Neuron_0x7f7409f44970(input);
  result.at(7) = Neuron_0x7f7409f45030(input);
  result.at(8) = Neuron_0x7f7409f456f0(input);
  result.at(9) = Neuron_0x7f7409f45db0(input);
  result.at(10) = Neuron_0x7f7409f46470(input);
  result.at(11) = Neuron_0x7f7409f46b30(input);
  result.at(12) = Neuron_0x7f7409f471f0(input);
  result.at(13) = Neuron_0x7f7409f478b0(input);
  result.at(14) = Neuron_0x7f7409f47f70(input);
  result.at(15) = Neuron_0x7f7409f60670(input);
  return result;
}
double Neuron_0x7f7409f60d60(Vector<double, 16> input) {
  Vector<double, 16> weights = {
...
Vector<double, 1> Layer_0x7f741791ffd0(Vector<double, 16> input) {
  Vector<double, 1> result;
  result.at(0) = Neuron_0x7f7409f60d60(input);
  return result;
}
Vector<double, 1> MLP_0x7f7417956cb0(Vector<double, 2> input) {
  Vector<double, 16> result0 = Layer_0x7f741798ff70(input);
  Vector<double, 16> result1 = Layer_0x7f741798d8d0(result0);
  Vector<double, 1> result2 = Layer_0x7f741791ffd0(result1);
  return result2;
}
